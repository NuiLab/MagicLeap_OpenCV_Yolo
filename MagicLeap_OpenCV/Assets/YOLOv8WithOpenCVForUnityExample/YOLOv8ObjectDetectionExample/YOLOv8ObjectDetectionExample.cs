...
namespace YOLOv8WithOpenCVForUnityExample
{
    ...
    public class YOLOv8ObjectDetectionExample : MonoBehaviour
    {
        ...
        protected SimpleCameraDisplay simpleCameraDisplay;
        ...
        protected virtual void Start()
        {
            ...
            simpleCameraDisplay = gameObject.GetComponent<SimpleCameraDisplay>();
        ...
        public virtual void OnWebCamTextureToMatHelperInitialized()
        {
            ...
            Mat webCamTextureMat = simpleCameraDisplay.GetMat();
